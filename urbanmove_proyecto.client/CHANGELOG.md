...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest urbanmove_proyecto.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`urbanmove_proyecto.client.esproj`).
