...
{
    /// <inheritdoc />
    public partial class AddedBaseDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Geometry = table.Column<LineString>(type: "LINESTRING", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EcoPointsAccounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EcoPointsAccounts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EcoTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EcoTransactions_EcoPointsAccounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "EcoPointsAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IncidentImages_IncidentReports_IncidentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EcoPointsAccounts_UserId",
                table: "EcoPointsAccounts",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_EcoTransactions_AccountId",
                table: "EcoTransactions",
                column: "AccountId");
